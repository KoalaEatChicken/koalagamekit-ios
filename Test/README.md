...
- [koalagamekit-ios #](#koalagamekit-ios-#)
- [考拉游戏平台SDK接入文档【iOS端】v2.0](#考拉游戏平台SDK接入文档【iOS端】v2.0)
    - [1. 工程配置](#1.-工程配置)
        - [1.1 引入KoalaGameKit](#1.1-引入KoalaGameKit)
            - [1.1.1 SDK文件清单](#1.1.1-SDK文件清单)
            - [1.1.2 引入项目文件](#1.1.2-引入项目文件)
        - [1.2 info.plist文件](#1.2-info.plist文件)
        - [1.3 其他说明](#1.3-其他说明)
    - [2. 快速接入](#2.-快速接入)
- [import <KoalaGameKit/KoalaGameKit.h>](#import-<KoalaGameKit/KoalaGameKit.h>)
        - [2.1 初始化](#2.1-初始化)
            - [2.1.1 直接上代码](#2.1.1-直接上代码)
            - [2.1.2 配置模型](#2.1.2-配置模型)
            - [2.1.3 特殊说明](#2.1.3-特殊说明)
        - [2.2 登录](#2.2-登录)
            - [2.2.1 直接上代码](#2.2.1-直接上代码)
            - [2.2.2  用户模型](#2.2.2--用户模型)
            - [2.2.3 特殊说明](#2.2.3-特殊说明)
        - [2.3 上传用户扩展信息](#2.3-上传用户扩展信息)
            - [2.3.1 直接上代码](#2.3.1-直接上代码)
            - [2.3.2  角色模型](#2.3.2--角色模型)
        - [2.4 登出](#2.4-登出)
            - [2.4.1 直接上代码](#2.4.1-直接上代码)
            - [2.4.2 特殊说明](#2.4.2-特殊说明)
        - [2.5 支付](#2.5-支付)
            - [2.5.1 直接上代码](#2.5.1-直接上代码)
            - [2.5.2 订单模型](#2.5.2-订单模型)
            - [2.5.3 特殊说明](#2.5.3-特殊说明)
    - [3. FAQ](#3.-FAQ)
        - [3.1 常见崩溃问题及解决方案](#3.1-常见崩溃问题及解决方案)
            - [Q1. 动态库没有被正确的加载，而导致的崩溃.](#Q1.-动态库没有被正确的加载，而导致的崩溃.)
